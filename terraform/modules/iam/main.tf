...
resource "aws_iam_role_policy" "ecs_task_execution_role_policy" {
  name = "${var.app_name}-${var.environment}-ecs-task-execution-policy"
...
# Task role policy for EFS access (if using EFS)
resource "aws_iam_role_policy" "ecs_task_role_efs_policy" {
  count = var.database_type == "efs" ? 1 : 0
  name  = "${var.app_name}-${var.environment}-ecs-task-efs-policy"
...
# Task role policy for basic CloudWatch and Secrets Manager access
